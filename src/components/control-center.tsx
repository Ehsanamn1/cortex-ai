  ...
  return <div className="min-h-screen bg-background text-foreground">
    ...
    <main className="mx-auto max-w-7xl space-y-7 px-5 py-6 lg:px-8 lg:py-8">
      ...
      <section className="grid gap-5 xl:grid-cols-2">
        <Card className="cortex-panel rounded-2xl">
          <CardHeader><CardTitle className="text-base">قابلیت‌ها و ناوبری</CardTitle></CardHeader>
          <CardContent className="space-y-5">
            <div className="rounded-2xl border border-white/[.06] bg-black/10 p-4">
              <p className="text-sm font-semibold">ترتیب منوی اصلی</p>
              <p className="mt-1 text-xs leading-6 text-muted-foreground">کلیدها را با کاما جدا کن. موارد ناشناخته نادیده گرفته می‌شوند.</p>
              <Textarea dir="ltr" className="mt-3 min-h-20 font-mono text-xs text-left" value={settings["site.navOrder"]||""} onChange={e=>updateSetting("site.navOrder",e.target.value)} />
            </div>
            <div className="grid gap-2 sm:grid-cols-2">
              <div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] bg-white/[.02] p-3"><div className="min-w-0"><p className="text-sm font-medium">داشبورد</p><p className="mt-1 text-[10px] text-muted-foreground">نمایش در منوی اصلی</p></div><Switch checked={settings["nav.dashboard.enabled"]!=="false"} onCheckedChange={v=>updateSetting("nav.dashboard.enabled",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] bg-white/[.02] p-3"><div className="min-w-0"><p className="text-sm font-medium">ایجنت‌ها</p><p className="mt-1 text-[10px] text-muted-foreground">نمایش در منوی اصلی</p></div><Switch checked={settings["nav.agents.enabled"]!=="false"} onCheckedChange={v=>updateSetting("nav.agents.enabled",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] bg-white/[.02] p-3"><div className="min-w-0"><p className="text-sm font-medium">دانش</p><p className="mt-1 text-[10px] text-muted-foreground">نمایش در منوی اصلی</p></div><Switch checked={settings["nav.knowledge.enabled"]!=="false"} onCheckedChange={v=>updateSetting("nav.knowledge.enabled",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] bg-white/[.02] p-3"><div className="min-w-0"><p className="text-sm font-medium">گفتگوها</p><p className="mt-1 text-[10px] text-muted-foreground">نمایش در منوی اصلی</p></div><Switch checked={settings["nav.conversations.enabled"]!=="false"} onCheckedChange={v=>updateSetting("nav.conversations.enabled",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] bg-white/[.02] p-3"><div className="min-w-0"><p className="text-sm font-medium">تلگرام</p><p className="mt-1 text-[10px] text-muted-foreground">نمایش در منوی اصلی</p></div><Switch checked={settings["nav.telegram.enabled"]!=="false"} onCheckedChange={v=>updateSetting("nav.telegram.enabled",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] bg-white/[.02] p-3"><div className="min-w-0"><p className="text-sm font-medium">تحلیل</p><p className="mt-1 text-[10px] text-muted-foreground">نمایش در منوی اصلی</p></div><Switch checked={settings["nav.analytics.enabled"]!=="false"} onCheckedChange={v=>updateSetting("nav.analytics.enabled",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] bg-white/[.02] p-3"><div className="min-w-0"><p className="text-sm font-medium">مدیریت</p><p className="mt-1 text-[10px] text-muted-foreground">نمایش در منوی اصلی</p></div><Switch checked={settings["nav.admin.enabled"]!=="false"} onCheckedChange={v=>updateSetting("nav.admin.enabled",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] bg-white/[.02] p-3"><div className="min-w-0"><p className="text-sm font-medium">آموزش</p><p className="mt-1 text-[10px] text-muted-foreground">نمایش در منوی اصلی</p></div><Switch checked={settings["nav.learn.enabled"]!=="false"} onCheckedChange={v=>updateSetting("nav.learn.enabled",v?"true":"false")} /></div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="cortex-panel rounded-2xl">
          ...
          <CardContent className="space-y-2">
            <div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] p-3"><div><p className="text-sm font-medium">Hero داشبورد</p><p className="mt-1 text-[10px] text-muted-foreground">هسته‌ی تصویری بزرگ بالای داشبورد</p></div><Switch checked={settings["feature.dashboardHero"]!=="false"} onCheckedChange={v=>updateSetting("feature.dashboardHero",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] p-3"><div><p className="text-sm font-medium">عملیات سریع</p><p className="mt-1 text-[10px] text-muted-foreground">کارت‌های اقدام سریع</p></div><Switch checked={settings["feature.dashboardQuickActions"]!=="false"} onCheckedChange={v=>updateSetting("feature.dashboardQuickActions",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] p-3"><div><p className="text-sm font-medium">داده‌های اخیر</p><p className="mt-1 text-[10px] text-muted-foreground">ایجنت‌ها و گفتگوهای اخیر</p></div><Switch checked={settings["feature.dashboardRecent"]!=="false"} onCheckedChange={v=>updateSetting("feature.dashboardRecent",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] p-3"><div><p className="text-sm font-medium">Activity Log</p><p className="mt-1 text-[10px] text-muted-foreground">رخدادهای آخر سیستم</p></div><Switch checked={settings["feature.dashboardActivity"]!=="false"} onCheckedChange={v=>updateSetting("feature.dashboardActivity",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] p-3"><div><p className="text-sm font-medium">پنل برند ورود</p><p className="mt-1 text-[10px] text-muted-foreground">پنل تصویری صفحه ورود و ثبت‌نام</p></div><Switch checked={settings["feature.authBrandPanel"]!=="false"} onCheckedChange={v=>updateSetting("feature.authBrandPanel",v?"true":"false")} /></div><div className="flex items-center justify-between gap-3 rounded-xl border border-white/[.06] p-3"><div><p className="text-sm font-medium">دکمه ساخت Agent</p><p className="mt-1 text-[10px] text-muted-foreground">CTA بالای داشبورد</p></div><Switch checked={settings["feature.createAgentCta"]!=="false"} onCheckedChange={v=>updateSetting("feature.createAgentCta",v?"true":"false")} /></div>
          </CardContent>
        </Card>
      </section>
      ...
      <section className="grid gap-5 xl:grid-cols-[.8fr_1.2fr]">
        ...
        <Card className="cortex-panel rounded-2xl"><CardHeader><CardTitle className="text-base">تنظیمات قابل ویرایش محصول</CardTitle></CardHeader><CardContent className="grid gap-4 sm:grid-cols-2">
          ...
          <div><Label>گردی گوشه‌ها (rem)</Label><Input dir="ltr" type="number" min={0.25} max={2} step={0.05} className="mt-2 text-left" value={settings["site.radius"]||"0.75"} onChange={e=>updateSetting("site.radius",e.target.value)}/></div>
          <div><Label>رنگ نوار کناری</Label><Input dir="ltr" className="mt-2 text-left" placeholder="#0A0D13" value={settings["site.sidebarColor"]||"#0A0D13"} onChange={e=>updateSetting("site.sidebarColor",e.target.value)}/></div>
          <div className="sm:col-span-2 border-t border-white/[.06] pt-5"><p className="text-sm font-semibold">برچسب‌های منو</p><p className="mt-1 text-xs text-muted-foreground">نام نمایشی هر بخش را بدون تغییر در منطق آن عوض کن.</p></div>
          <div className="sm:col-span-2 grid gap-3 md:grid-cols-2"><div><Label>عنوان داشبورد</Label><Input className="mt-2" value={settings["nav.dashboard.label"]||""} onChange={e=>updateSetting("nav.dashboard.label",e.target.value)}/></div><div><Label>عنوان ایجنت‌ها</Label><Input className="mt-2" value={settings["nav.agents.label"]||""} onChange={e=>updateSetting("nav.agents.label",e.target.value)}/></div><div><Label>عنوان دانش</Label><Input className="mt-2" value={settings["nav.knowledge.label"]||""} onChange={e=>updateSetting("nav.knowledge.label",e.target.value)}/></div><div><Label>عنوان گفتگوها</Label><Input className="mt-2" value={settings["nav.conversations.label"]||""} onChange={e=>updateSetting("nav.conversations.label",e.target.value)}/></div><div><Label>عنوان تلگرام</Label><Input className="mt-2" value={settings["nav.telegram.label"]||""} onChange={e=>updateSetting("nav.telegram.label",e.target.value)}/></div><div><Label>عنوان تحلیل</Label><Input className="mt-2" value={settings["nav.analytics.label"]||""} onChange={e=>updateSetting("nav.analytics.label",e.target.value)}/></div><div><Label>عنوان مدیریت</Label><Input className="mt-2" value={settings["nav.admin.label"]||""} onChange={e=>updateSetting("nav.admin.label",e.target.value)}/></div><div><Label>عنوان آموزش</Label><Input className="mt-2" value={settings["nav.learn.label"]||""} onChange={e=>updateSetting("nav.learn.label",e.target.value)}/></div></div>
